...
open class MaterialButtonRegular : MaterialButton {
    ...
    private var attrBgDisableTextColor = Color.BLACK
    ...
    private fun applyAttributes(attrs: AttributeSet,context: Context){
        ...
        attrCornerRadius = typedArray.getDimension(R.styleable.MaterialButtonRegular_mt_btn_corner_radius,0f)
        attrTopLeftCornerRadius = typedArray.getDimension(R.styleable.MaterialButtonRegular_mt_btn_topLeft_corner_radius,0f)
        attrTopRightCornerRadius = typedArray.getDimension(R.styleable.MaterialButtonRegular_mt_btn_topRight_corner_radius,0f)
        attrBottomLeftCornerRadius = typedArray.getDimension(R.styleable.MaterialButtonRegular_mt_btn_bottomLeft_corner_radius,0f)
        attrBottomRightCornerRadius = typedArray.getDimension(R.styleable.MaterialButtonRegular_mt_btn_bottomRight_corner_radius,0f)
        val attrShapeTypeInt = typedArray.getInt(R.styleable.MaterialButtonRegular_mt_btn_background_shape,-1)
        attrStrokeColor = typedArray.getColor(R.styleable.MaterialButtonRegular_mt_btn_stroke_color,Color.TRANSPARENT)
        attrStrokeWidth = typedArray.getDimension(R.styleable.MaterialButtonRegular_mt_btn_stroke_width,0f)
        attrBgDisableColor = typedArray.getColor(R.styleable.MaterialButtonRegular_mt_btn_disable_bg_color, Color.GRAY)
        attrBgDisableTextColor = typedArray.getColor(R.styleable.MaterialButtonRegular_mt_btn_disable_text_color, Color.BLACK)
        attrGradientOrientation = GradientOrientation.values()[typedArray.getInt(R.styleable.MaterialButtonRegular_mt_btn_gradient_orientation, 0)]
        attrGradientTopColor = typedArray.getColor(R.styleable.MaterialButtonRegular_mt_btn_gradient_top_color,-1)
        attrGradientMiddleColor = typedArray.getColor(R.styleable.MaterialButtonRegular_mt_btn_gradient_middle_color,-1)
        attrGradientBottomColor = typedArray.getColor(R.styleable.MaterialButtonRegular_mt_btn_gradient_bottom_color,-1)
        attrRippleColor = typedArray.getColor(R.styleable.MaterialButtonRegular_mt_btn_ripple_color,Color.LTGRAY)
        typedArray.recycle()

        //--------------set button text color sate Enable color and disable color-----------------
