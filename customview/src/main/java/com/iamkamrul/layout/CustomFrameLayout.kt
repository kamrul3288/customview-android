...
class CustomCustomFrameLayout : FrameLayout{
    ...
    private fun applyAttributes(attrs: AttributeSet,context: Context){
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.CustomFrameLayout,0,0)
        attrCornerRadius = typedArray.getDimension(R.styleable.CustomFrameLayout_fl_corner_radius,0f)
        attrTopLeftCornerRadius = typedArray.getDimension(R.styleable.CustomFrameLayout_fl_topLeft_corner_radius,0f)
        attrTopRightCornerRadius = typedArray.getDimension(R.styleable.CustomFrameLayout_fl_topRight_corner_radius,0f)
        attrBottomLeftCornerRadius = typedArray.getDimension(R.styleable.CustomFrameLayout_fl_bottomLeft_corner_radius,0f)
        attrBottomRightCornerRadius = typedArray.getDimension(R.styleable.CustomFrameLayout_fl_bottomRight_corner_radius,0f)
        val attrShapeTypeInt = typedArray.getInt(R.styleable.CustomFrameLayout_fl_background_shape,-1)
        attrStrokeColor = typedArray.getColor(R.styleable.CustomFrameLayout_fl_stroke_color,Color.TRANSPARENT)
        attrStrokeWidth = typedArray.getDimension(R.styleable.CustomFrameLayout_fl_stroke_width,0f)
        attrBgDisableColor = typedArray.getColor(R.styleable.CustomFrameLayout_fl_disable_bg_color, Color.GRAY)
        attrGradientOrientation = GradientOrientation.values()[typedArray.getInt(R.styleable.CustomFrameLayout_fl_gradient_orientation, 0)]
        attrGradientTopColor = typedArray.getColor(R.styleable.CustomFrameLayout_fl_gradient_top_color,-1)
        attrGradientMiddleColor = typedArray.getColor(R.styleable.CustomFrameLayout_fl_gradient_middle_color,-1)
        attrGradientBottomColor = typedArray.getColor(R.styleable.CustomFrameLayout_fl_gradient_bottom_color,-1)
        attrRippleColor = typedArray.getColor(R.styleable.CustomFrameLayout_fl_ripple_color,Color.TRANSPARENT)
        typedArray.recycle()
